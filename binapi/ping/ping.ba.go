...
//
// WantPingEvents defines message 'want_ping_events'.
type WantPingEvents struct {
...
func (m *WantPingEvents) Reset()               { *m = WantPingEvents{} }
func (*WantPingEvents) GetMessageName() string { return "want_ping_events" }
func (*WantPingEvents) GetCrcString() string   { return "e79ee58b" }
func (*WantPingEvents) GetMessageType() api.MessageType {
	return api.RequestMessage
}

func (m *WantPingEvents) Size() (size int) {
	if m == nil {
		return 0
	}
	size += 1      // m.Address.Af
...
func (m *WantPingEvents) Marshal(b []byte) ([]byte, error) {
	if b == nil {
		b = make([]byte, m.Size())
	}
	buf := codec.NewBuffer(b)
...
func (m *WantPingEvents) Unmarshal(b []byte) error {
	buf := codec.NewBuffer(b)
...
// WantPingEventsReply defines message 'want_ping_events_reply'.
type WantPingEventsReply struct {
	Retval int32 `binapi:"i32,name=retval" json:"retval,omitempty"`
}

func (m *WantPingEventsReply) Reset()               { *m = WantPingEventsReply{} }
func (*WantPingEventsReply) GetMessageName() string { return "want_ping_events_reply" }
func (*WantPingEventsReply) GetCrcString() string   { return "e8d4e804" }
func (*WantPingEventsReply) GetMessageType() api.MessageType {
	return api.ReplyMessage
}

func (m *WantPingEventsReply) Size() (size int) {
	if m == nil {
		return 0
	}
	size += 4 // m.Retval
...
func (m *WantPingEventsReply) Marshal(b []byte) ([]byte, error) {
	if b == nil {
		b = make([]byte, m.Size())
	}
	buf := codec.NewBuffer(b)
...
func (m *WantPingEventsReply) Unmarshal(b []byte) error {
	buf := codec.NewBuffer(b)
...
func file_ping_binapi_init() {
	...
	api.RegisterMessage((*WantPingEvents)(nil), "want_ping_events_e79ee58b")
	api.RegisterMessage((*WantPingEventsReply)(nil), "want_ping_events_reply_e8d4e804")
}
